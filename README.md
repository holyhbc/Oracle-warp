...
```
bash <(curl -sSL https://raw.githubusercontent.com/holyhbc/Oracle-warp/main/root.sh)
```
-----------------------------------------------------------------------------------------------------
...
```
wget -N --no-check-certificate https://raw.githubusercontent.com/holyhbc/Oracle-warp/main/multiX86.sh && chmod +x multiX86.sh && ./multiX86.sh
```
...
```
wget -N --no-check-certificate https://raw.githubusercontent.com/holyhbc/Oracle-warp/main/multiARM.sh && chmod +x multiARM.sh && ./multiARM.sh
```
